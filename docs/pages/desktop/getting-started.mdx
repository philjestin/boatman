...
Memory documents are Markdown files with frontmatter. Boatman can load them as prompt context for future sessions, and users can inspect them directly in the Runtime tab before trusting the context.
