...
4. Optional extra review skills run after the primary review, and their blocking feedback is merged
5. The pass/fail decision uses configurable thresholds
6. If review fails, the **refactor agent** addresses the issues
7. The **diff verifier** confirms issues were actually addressed
