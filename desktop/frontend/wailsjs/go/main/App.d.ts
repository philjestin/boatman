...
export function ClearSessionConversation(arg1:string):Promise<void>;
...
export function GetBrain(arg1:string):Promise<services.BrainDetail>;

export function GetBrainDirs():Promise<Array<string>>;
...
export function GetIntegrationStatuses():Promise<Array<integrations.Status>>;
...
export function GetSessionSystemPrompt(arg1:string):Promise<string>;
...
export function ListBrains():Promise<Array<services.BrainEntry>>;
...
export function MatchBrains(arg1:Array<string>,arg2:Array<string>,arg3:Array<string>):Promise<Array<services.BrainEntry>>;
...
export function SetBrainProjectPath(arg1:string):Promise<void>;
...
export function SetSessionSystemPrompt(arg1:string,arg2:string):Promise<void>;
...
export function ValidateBrain(arg1:string):Promise<services.BrainValidationResult>;
