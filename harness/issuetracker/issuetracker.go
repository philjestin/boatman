...
func (t *IssueTracker) Track(issues []review.Issue) []TrackedIssue {
...
func (t *IssueTracker) generateIssueID(issue review.Issue) string {
...
func (t *IssueTracker) findSimilarIssue(issue review.Issue) string {
...
func (h *IssueHistory) RecordIteration(issues []review.Issue) []TrackedIssue {
